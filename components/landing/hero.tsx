            ...
            <div className="relative mx-auto max-w-6xl px-6 py-24 md:py-32 lg:py-40">
                <div className="max-w-3xl">
                    ...
                    <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/80 md:text-xl">
                        ...
                        campus. Study MBBS fully in English. EU-accredited,
                        globally recognized, and open to <span className="text-accent font-medium">Indian students.</span>
                    </p>
                    ...
                    <div className="mt-10 flex flex-wrap gap-4">
                        <Button
                            variant={"outline"}
                            size="lg"
                            className="rounded-full h-12 bg-amber-300 border-none px-8 text-base font-semibold text-primary hover:bg-amber-400 hover:border-amber-400"
                            asChild
                        >
                            <Link href="https://application-portal.umch.de" target="_blank" rel="noopener noreferrer">Apply Now</Link>
                        </Button>
                        <Button
                            variant={"outline"}
                            size="lg"

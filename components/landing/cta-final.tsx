...
export function CtaFinal() {
  return (
    <section
      id="apply"
      className="bg-accent py-20 text-primary md:py-28"
    >
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:items-start lg:gap-16">
          ...
          <div className="text-center lg:flex-1 lg:text-left">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base text-primary lg:mx-0">
              ...
              international medical campus. <br />Fully
              English-taught.
            </p>
            ...
            <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
              ...
              <Button
                size="lg"
                variant="outline"
                className="rounded-full h-10 border border-white bg-accent/10 px-8 text-base font-semibold text-white hover:bg-primary/20 hover:border-primary hover:text-primary"
                asChild
              >
                <a href="https://edu.UMFST-UMCH.de/contact" target="_blank" rel="noopener noreferrer">
            ...
            <p className="mt-8 text-sm text-primary">
              Including a virtual campus tour. Our admissions team will get back to
              you within 24 hours.
            </p>
          </div>
          ...
          <div className="w-full lg:max-w-md">
            <form className="space-y-5 rounded-2xl bg-white p-8 shadow-lg md:p-10">
              ...
              <p className="text-sm text-muted-foreground">
                Have questions? Our admissions team will get back to you within 24&nbsp;hours.
              </p>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="John"
                    className="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-lg border border-border bg-background px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30"
                />
              </div>

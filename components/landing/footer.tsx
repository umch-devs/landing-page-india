        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-[1fr_1fr_auto_auto]">
          ...
          <div>
            ...
            <p className="mt-3 text-sm font-semibold text-accent">
              UMFST-UMFST-UMCH University Medicine of
              <br />
          ...
          {/* Resources */}
          <div>
            <h3 className="text-sm font-semibold text-accent">Resources</h3>
            <ul className="mt-4 space-y-2.5">
              {resources.map((link) => (
                <li key={link.label}>
                  <a
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-6">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            {/* Nobel laureate */}
            <div className="flex items-center gap-3">
              <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-amber-700 text-lg">
                🏅
              </div>
            ...
            <div className="text-right text-xs">
              <p className="font-bold text-white/80">
                CIS <span className="text-white/50">MEMBER</span>
              </p>

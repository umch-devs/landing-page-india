      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            ...
            students. They share their experiences with the modern medical
            campus, first-class facilities, practice-oriented education, and
            life in Hamburg.
          </p>
        </div>
              ...
              .map((t) => (
                ...
                >
                  ...
                  <div className="relative h-56 bg-slate-200">
                    ...
                    {/* Country badge */}
                    <span className="absolute top-3 right-3 rounded-full border border-white/30 bg-white/90 px-3 py-1 text-xs font-semibold text-primary shadow-sm">
                      {t.country}
                    </span>
